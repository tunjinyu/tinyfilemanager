...
$external = array(
    ...
    'js-jquery' => '<script src="https://ajax.aspnetcdn.com/ajax/jquery/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>',
...
function lng($txt) {
    ...
    $tr['cn']['Owner']        = '拥有者';
    $tr['cn']['Search']        = '查找';
    $tr['cn']['NewItem']        = '创建新文件/文件夹';
    $tr['cn']['Folder']        = '文件夹';
    $tr['cn']['Delete']        = '删除';
    $tr['cn']['CopyTo']        = '复制到';
    $tr['cn']['DirectLink']        = '直链';
    $tr['cn']['UploadingFiles']        = '上传';
    $tr['cn']['ChangePermissions']        = '修改权限';
    $tr['cn']['Copying']        = '复制中';
    $tr['cn']['CreateNewItem']        = '创建新文件';
    $tr['cn']['Name']        = '文件名';
    $tr['cn']['AdvancedEditor']        = '高级编辑器';
    $tr['cn']['RememberMe']        = '记住登录信息';
    $tr['cn']['Actions']        = '执行操作';
    $tr['cn']['Upload']        = '上传';
    $tr['cn']['Cancel']        = '取消';
    $tr['cn']['InvertSelection']        = '反向选择';
    $tr['cn']['DestinationFolder']        = '目标文件夹';
    $tr['cn']['ItemType']        = '文件类型';
    $tr['cn']['ItemName']        = '创建名称';
    $tr['cn']['CreateNow']        = '创建';
    $tr['cn']['Download']        = '下载';
    $tr['cn']['UnZip']        = '解压缩';
    $tr['cn']['UnZipToFolder']        = '解压至目标文件夹';
    $tr['cn']['Edit']        = '编辑';
    $tr['cn']['NormalEditor']        = '编辑器';
    $tr['cn']['BackUp']        = '备份';
    $tr['cn']['SourceFolder']        = '源文件夹';
    $tr['cn']['Files']        = '文件';
    $tr['cn']['Change']        = '修改';
    $tr['cn']['Settings']        = '设置';
    $tr['cn']['Language']        = '语言';
    ...
    $tr['cn']['enable']        = '启用';
    $tr['cn']['disable']        = '禁用';
    $tr['cn']['ErrorReporting']        = '上传错误报告';
    $tr['cn']['ShowHiddenFiles']        = '显示隐藏文件';
    $tr['cn']['Help']        = '帮助';
    $tr['cn']['HideColumns']        = '隐藏权限&拥有者';
    $tr['cn']['CalculateFolderSize']        = '显示文件夹大小';
    $tr['cn']['FullSize']        = '所有文件大小';
    $tr['cn']['MemoryUsed']        = '使用内存';
    $tr['cn']['PartitionSize']        = '可用空间';
    $tr['cn']['FreeOf']        = '磁盘大小';
    $tr['cn']['Check Latest Version']        = '检查更新';
    $tr['cn']['Generate new password hash']        = '生成新的hash密码';
    $tr['cn']['Report Issue']        = '报告问题';
    $tr['cn']['Help Documents']        = '帮助文档';
    $tr['cn']['Generate']        = '生成';
    $tr['cn']['Renamed from']        = '生成';
    $tr['cn']['Preview']        = '预览';
    $tr['cn']['Access denied. IP restriction applicable']        = '访问被拒绝。适用的IP限制';
    $tr['cn']['You are logged in']        = '您已登录';
    $tr['cn']['Login failed. Invalid username or password']        = '登录失败。用户名或密码无效';
    $tr['cn']['password_hash not supported, Upgrade PHP version']        = '不支持password_hash,请升级PHP版本';
    $tr['cn']['Root path']        = '根路径';
    $tr['cn']['not found!']        = '没有找到！';
    $tr['cn']['File not found']        = '找不到文件';
    $tr['cn']['Deleted']        = '删除';
    $tr['cn']['not deleted']        = '未删除';
    $tr['cn']['Invalid file or folder name']        = '无效的文件或文件夹名';
    $tr['cn']['Created']        = '已创建';
    $tr['cn']['File extension is not allowed']        = '不允许文件扩展名';
    $tr['cn']['already exists']        = '已经存在';
    $tr['cn']['not created']        = '未创建';
    $tr['cn']['Invalid characters in file or folder name']        = '文件或文件夹名称中的无效字符';
    $tr['cn']['Source path not defined']        = '未定义源路径';
    $tr['cn']['Moved from']        = '移动自';
    $tr['cn']['to']        = '至';
    $tr['cn']['File or folder with this path already exists']        = '具有此路径的文件或文件夹已存在';
    $tr['cn']['Error while moving from']        = '移动时出错';
    $tr['cn']['Copied from']        = '复制自';
    $tr['cn']['Error while copying from']        = '复制时出错';
    $tr['cn']['Paths must be not equal']        = '路径必须不相等';
    $tr['cn']['Nothing selected']        = '未选择任何内容';
    $tr['cn']['Error while renaming from']        = '重命名时出错';
    $tr['cn']['Invalid characters in file name']        = '文件名中的无效字符';
    $tr['cn']['Invalid Token.']        = '无效令牌。';
    $tr['cn']['Selected files and folder deleted']        = '已删除选定的文件和文件夹';
    $tr['cn']['Error while deleting items']        = '删除项目时出错';
    $tr['cn']['Operations with archives are not available']        = '存档操作不可用';
    $tr['cn']['Archive']        = '存档';
    $tr['cn']['Archive not created']        = '未创建存档';
    $tr['cn']['Archive unpacked']        = '存档未打包';
    $tr['cn']['Archive not unpacked']        = '存档未打开';
    $tr['cn']['Permissions changed']        = '权限已更改';
    $tr['cn']['Permissions not changed']        = '权限未更改';
    $tr['cn']['Select folder']        = '选择文件夹';
    $tr['cn']['Theme']        = '主题';
    $tr['cn']['light']        = '浅色';
    $tr['cn']['dark']        = '深色';
    $tr['cn']['Error while fetching archive info']        = '获取存档信息时出错';
    $tr['cn']['File Saved Successfully']        = '文件保存成功';
    $tr['cn']['FILE EXTENSION HAS NOT SUPPORTED']        = '文件扩展名不受支持';
    $tr['cn']['Folder is empty']        = '文件夹为空';
    $tr['cn']['Delete selected files and folders?']        = '是否删除选定的文件和文件夹？';
    $tr['cn']['Create archive?']        = '创建存档？';
    $tr['cn']['Zip']        = 'Zip';
    $tr['cn']['Tar']        = 'Tar';
    $tr['cn']['Zero byte file! Aborting download']        = '零字节文件！正在中止下载';
    $tr['cn']['Cannot open file! Aborting download']        = '无法打开文件！正在中止下载';
    $tr['cn']['Filter']        = '过滤器';
    $tr['cn']['Advanced Search']        = '高级搜索';
    $tr['cn']['Search file in folder and subfolders...']        = '在文件夹和子文件夹中搜索文件…';
    $tr['cn']['Are you sure want to']        = '你确定要';
    $tr['cn']['Okay']        = '确定';
    $tr['cn']['a files']        = '一个文件';
    $tr['cn']['Enter here...']        = '在此处输入...';
    $tr['cn']['Enter new file name']        = '输入新文件名';
    $tr['cn']['Full path']        = '完整路径';
    $tr['cn']['File size']        = '文件大小';
    $tr['cn']['MIME-type']        = 'MIME类型';
    $tr['cn']['Image sizes']        = '图像大小';
    $tr['cn']['Charset']        = '编码格式';
    $tr['cn']['Image']        = '图片';
    $tr['cn']['Audio']        = '音频';
    $tr['cn']['Video']        = '视频';
    $tr['cn']['Upload from URL']        = '从URL上传';
    $tr['cn']['Files in archive']        = '档案文件';
    $tr['cn']['Total size']        = '总大小';
    $tr['cn']['Compression']        = '压缩';
    $tr['cn']['Size in archive']        = '存档中的大小';
    $tr['cn']['Invalid Token.']        = '无效令牌';
    $tr['cn']['Fullscreen']        = '全屏';
    $tr['cn']['Search']        = '搜索';
    $tr['cn']['Word Wrap']        = '自动换行';
    $tr['cn']['Undo']        = '撤消';
    $tr['cn']['Redo']        = '恢复';
    $tr['cn']['Select Document Type']        = '选择文档类型';
    $tr['cn']['Select Mode']        = '选择模式';
    $tr['cn']['Select Theme']        = '选择主题';
    $tr['cn']['Select Font Size']        = '选择字体大小';
    $tr['cn']['Are you sure want to rename?']        = '是否确实要重命名?';
